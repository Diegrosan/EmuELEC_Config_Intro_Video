...
if [ "$1" == "intro" ]; then
	...
	#add new
	SPLASH="/storage/.config/splash/intro1_1080.mp4"
...
if [ -f $SPLASH1 ]; then
	...
	#add new
	SPLASH="/storage/.config/splash/loading-game2.gif"
...
#add new
#video time Total = 21+1, pause emulationstation in 22 sec and start
sleep 22